module georef
! Fortran90 module
! Set of conversion tools between geographic coordinates and UTM ones :
...
!
! You are free to use this code. If you find it useful, please advertize
! this original version. Any feedback is useful and will be welcome.
! Thank you.
!
! Warning : This code is very simple and do not take into account complex
! UTM zonation. Use it at your own risk!
!
   implicit none
